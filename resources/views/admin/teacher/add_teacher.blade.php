...
<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="{{ route('admin.teacher.create') }}">
        ...
        <div class="form-row">
            <div class="fpb-7">
                <label for="name" class="eForm-label">{{ get_phrase('Last Name') }}</label>
                <input type="text" class="form-control eForm-control" id="lastName" required>
            </div>
            <div class="fpb-7">
                <label for="name" class="eForm-label">{{ get_phrase('First Name') }}</label>
                <input type="text" class="form-control eForm-control" id="firstName"  required>
            </div>
            <div class="fpb-7">
                <label for="name" class="eForm-label">{{ get_phrase('MI *optional') }}</label>
