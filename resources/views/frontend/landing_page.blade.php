    ...
    <div class="container-xl">
        <div class="row align-items-center">
            <div class="col-lg-2 col-md-6 col-sm-6 col-5">
                <!-- Logo  -->
                <div class="logo">
                    <a href="#"><img src="{{ asset('public/frontend/assets/image/jbklogo.png') }}" alt="logo"></a> 
                </div>
            </div>
            <div class="col-lg-7 col-md-6 menu-items">
                ...
                <a class="small-device-show" href="#"><img src="{{ asset('public/frontend/assets/image/jbklogo.png') }}" alt="logo"></a>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="bananr-right-img">
                    <img src="{{ asset('public/frontend/assets/image/ban-img1.png') }}" alt="image">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 mb-5">
                    <div class="footer-items">
                        <div class="footer-logo">
                            <a href="#"><img src="{{ asset('public/frontend/assets/image/jbklogo.png') }}" alt="image"></a>
                        </div>
