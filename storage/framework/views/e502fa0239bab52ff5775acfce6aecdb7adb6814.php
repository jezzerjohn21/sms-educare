      ...
      <div class="col-12">
        ...
        >
          <div class="d-flex flex-column">
            <h4><?php echo e(get_phrase('Student List')); ?></h4>
            <ul class="d-flex align-items-center eBreadcrumb-2">
              <li><a href="#"><?php echo e(get_phrase('Home')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('Users')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('Student List')); ?></a></li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="col-12">
        <div class="eSection-wrap pb-2">
            <div class="search-filter-area d-flex justify-content-md-between justify-content-center align-items-center flex-wrap gr-15">
                <form action="<?php echo e(route('parent.childlist')); ?>">
                  <div
                ...
                <div class="position-relative">
                  ...
                  >
                    ...
                    <li>
                        <a class="dropdown-item" id="print" href="javascript:;" onclick="printableDiv('child_list')"><?php echo e(get_phrase('Print')); ?></a>
                    </li>
                  </ul>
                </div>
                <?php endif; ?>
				...
				<table id="basic-datatable" class="table eTable eTable-2">
				    <thead>
				        <tr>
                            ...
                            <th scope="col"><?php echo e(get_phrase('Id card')); ?></th>
				        </tr>
				    </thead>
				    <tbody>
                        <?php $__currentLoopData = $students; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $student): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:;" class="btn btn-light-success py-1 px-2 text-14px mt-1" data-bs-toggle="tooltip" title="Id Card" onclick="largeModal('<?php echo e(route('parent.student.id_card', ['id' => $student->id])); ?>', '<?php echo e(get_phrase('Generate id card')); ?>')"><i class="bi bi-person-badge"></i></a>
                                </td>
                            </tr>
...
<script type="text/javascript">
  ...
  function Export() {
    ...
    var opt = {
      margin:       1,
      filename:     'child_list_<?php echo e(date("y-m-d")); ?>.pdf',
...
<?php echo $__env->make('parent.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\fernandez\Ekattor8\resources\views/parent/user/child_list.blade.php ENDPATH**/ ?>