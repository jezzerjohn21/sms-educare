<div class="eoff-form">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.create.subject')); ?>">
        ...
        <div class="form-row">
            ...
            <div class="fpb-7">
                <label for="class_id_on_create" class="eForm-label"><?php echo e(get_phrase('Asign a tearcher')); ?></label>
                <select name="teacher_id" id="teacher_id" class="form-select eForm-select eChoice-multiple-with-remove" required>
                    <option value=""><?php echo e(get_phrase('select a teacher to handle')); ?></option>
...
<?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/admin/subject/add_subject.blade.php ENDPATH**/ ?>