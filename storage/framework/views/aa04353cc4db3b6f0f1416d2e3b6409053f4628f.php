                        ...
                        <div class="dashboard_report dashboard_upcoming_events" style="background-color:	#191970">
                          ...
                          >
                            <div class="ds_report_left">
                              <h4 class="title"><?php echo e(get_phrase('Upcoming due')); ?></h4>
                            </div>
                          ...
                          <div class="ds_report_list pt-38">
                            <ul class="upcoming_events_items d-flex flex-column">
                                ...
                                <?php $upcoming_dues = DB::table('student_fee_managers')->where('school_id', auth()->user()->school_id)->where('student_id', auth()->user()->id)->where('status',value('unpaid') )->take(3)->orderBy('id', 'DESC')->get(); ?>
                                <?php $__currentLoopData = $upcoming_dues; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upcoming_due): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <div
                                    class="upcoming_events_item d-flex justify-content-between align-items-start"
                                    >
                                    <div class="events_info">
                                        <a href="#" class="title"><?php echo e($upcoming_due->title); ?></a> <span class="all_report_btn_2"><?php echo e($upcoming_due->status); ?></span>   <a href="#" class="title">₱ <?php echo e($upcoming_due->total_amount); ?></a>
                                        <p class="date"><?php echo e(date('D, M d Y', $upcoming_due->timestamp)); ?></p>
                            ...
                            <div class="text-end">
                              <a href="<?php echo e(route('student.fee_manager.list')); ?>" class="all_report_btn_2"><?php echo e(get_phrase('See all')); ?></a>
                            </div>
                          </div>
                        </div>
                      </div>
...
<?php echo $__env->make('student.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/student/dashboard.blade.php ENDPATH**/ ?>