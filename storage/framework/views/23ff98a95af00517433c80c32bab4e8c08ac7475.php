      ...
      <div class="col-12">
        ...
        >
          <div class="d-flex flex-column">
            <h4><?php echo e(get_phrase('Grade Category')); ?></h4>
            <ul class="d-flex align-items-center eBreadcrumb-2">
              <li><a href="#"><?php echo e(get_phrase('Home')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('Grading')); ?></a></li>
              <li><a href="#"><?php echo e(get_phrase('Grade Period')); ?></a></li>
            </ul>
          </div>
          <div class="export-btn-area">
            <a href="javascript:;" class="export_btn" onclick="rightModal('<?php echo e(route('admin.exam_category.open_modal')); ?>', '<?php echo e(get_phrase('Create Grade Period Category')); ?>')"><?php echo e(get_phrase('Add Grade Period Category')); ?></a>
          </div>
        </div>
      </div>
    </div>
                		...
                		<tr>
    						...
    						<td class="text-center">
                                <div class="adminTable-action">
                                    ...
                                    >
                                        <li>
                                            <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('admin.edit.exam_category', ['id' => $exam_category->id])); ?>', '<?php echo e(get_phrase('Edit Grade Period Category')); ?>')"><?php echo e(get_phrase('Edit')); ?></a>
                                        </li>
                                        <li>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/admin/exam_category/exam_category.blade.php ENDPATH**/ ?>