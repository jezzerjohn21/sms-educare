                ...
                <div class="tab-content payment_modalTab_content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade <?=$off?>" id="v-pills-offline" role="tabpanel" aria-labelledby="v-pills-offline-tab" tabindex="0">
                        ...
                        <div class="offline_payment_instruction">
                            <p>
                                <?php echo e(get_phrase('Instruction').': '.get_phrase('Admin will review your payment document and then approve the Payment.')); ?>
...
<?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/student/payment/payment_gateway.blade.php ENDPATH**/ ?>