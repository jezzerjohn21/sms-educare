            ...
            <div class="row mt-3">
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select eForm-select eChoice-multiple-with-remove" id = "session_from" name="session_from">
                        <option value=""><?php echo e(get_phrase('S-Y from')); ?></option>
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select eForm-select eChoice-multiple-with-remove" id = "session_to" name="session_to">
                        <option value=""><?php echo e(get_phrase('S-Y to')); ?></option>
                        <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $session): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($session->id); ?>"><?php echo e($session->session_title); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/admin/promotion/promotion.blade.php ENDPATH**/ ?>