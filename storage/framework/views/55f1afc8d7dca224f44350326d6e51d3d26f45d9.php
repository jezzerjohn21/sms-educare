  ...
  <div class="col-12">
    <div class="eSection-wrap-2">
      <div id="printableDiv">
        ...
        <h4 class="invoice_title pb-21"><?php echo e(get_settings('system_name')); ?> </h4>
        <h3 class="sub-title"><?php echo e(get_settings('address')); ?></h3>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/admin/student_fee_manager/invoice.blade.php ENDPATH**/ ?>