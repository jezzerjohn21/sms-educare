...
<div class="mark_report" id="mark_report">
    <table class="table eTable">
        <thead>
            <tr>
                <th><?php echo e(get_phrase('Student name')); ?></td>
                <th><?php echo e(get_phrase('Mark')); ?></td>
                <th><?php echo e(get_phrase('Grade point')); ?></td>
                <th><?php echo e(get_phrase('Comment')); ?></td>
                <th><?php echo e(get_phrase('Action')); ?></td>
            </tr>   
        </thead>
        <tbody>
...
</script><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/teacher/marks/marks_list.blade.php ENDPATH**/ ?>