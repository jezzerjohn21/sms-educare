            ...
            >
                ...
                <form action="<?php echo e(route('student.profile.update')); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <label for="eGenderList" class="eForm-label"
                        ><?php echo e(get_phrase('Sex')); ?></label
                    >
                    <select name="gender"
...
<?php echo $__env->make('student.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/student/profile/view.blade.php ENDPATH**/ ?>