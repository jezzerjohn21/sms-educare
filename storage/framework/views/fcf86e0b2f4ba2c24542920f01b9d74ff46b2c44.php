          ...
          <div class="att-report-summary order-1">
            ...
            <p class="summary-item">
              ...
              <span>
                ...
                <?php else: ?>
                  <?php echo e(date('d-M-Y', strtotime($last_row))); ?> <br>
                <?php endif; ?>
              </span>
            </p>
            <p class="summary-item"><?php echo e(get_phrase('Time')); ?>:
              <span>
                ...
                <?php else: ?>
                  <?php echo e(date('h:i:s', strtotime($last_row))); ?>
...
<?php echo $__env->make('teacher.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/teacher/attendance/attendance_list.blade.php ENDPATH**/ ?>