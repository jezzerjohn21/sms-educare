	...
	<div class="sidebar">
      ...
      <li class="nav-links-li <?php echo e(request()->is('student/dashboard') ? 'showMenu':''); ?>">
        <div class="iocn-link">
          ...
          <ul class="sub-menu">
              <li>
                  <a class="<?php echo e((request()->is('student/marks')) ? 'active' : ''); ?>" href="<?php echo e(route('student.marks')); ?>"><span><?php echo e(get_phrase('View Grades')); ?></span></a>
              </li>
              <li>
                  <a class="<?php echo e((request()->is('student/grade')) ? 'active' : ''); ?>" href="<?php echo e(route('student.grade_list')); ?>"><span><?php echo e(get_phrase('Honor roll guide')); ?></span></a>
              </li>
          </ul>
      </li>
              ...
              <svg xmlns="http://www.w3.org/2000/svg" id="Bold" viewBox="0 0 24 24" width="48" height="48">
                ...
                c0,0.477,0.384,0.859,0.859,0.859h17.613c0.474,0,0.859-0.382,0.859-0.859V1.195C19.665,0.721,19.281,0.337,18.807,0.337z
                 M17.948,17.946H2.052V4.528h15.896V17.946z"></path></svg>
						...
						<span class="link_name"><?php echo e(get_phrase('School')); ?></span>
					</a>
					<span class="arrow">
...
<?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/student/navigation.blade.php ENDPATH**/ ?>