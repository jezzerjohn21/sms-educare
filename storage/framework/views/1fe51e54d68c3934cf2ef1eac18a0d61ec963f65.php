...
<body>
	...
	<div class="sidebar">
      ...
      <li class="nav-links-li <?php echo e(request()->is('parent/noticeboard*') || request()->is('parent/events/list*') ? 'showMenu':''); ?>">
        <div class="iocn-link">
          <a href="#">
            <div class="sidebar_icon">
...
<?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/parent/navigation.blade.php ENDPATH**/ ?>