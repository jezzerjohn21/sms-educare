<div class="eoff-form">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.subject.update', ['id' => $subject->id])); ?>">
        ...
        <div class="form-row">
            ...
            <div class="fpb-7">
                <label for="class_id_on_create" class="eForm-label"><?php echo e(get_phrase('Edit assigned teacher')); ?></label>
                <select name="teacher_id" id="teacher_id" class="form-select eForm-select eChoice-multiple-with-remove" required>
                    <option value=""><?php echo e(get_phrase('Select a teacher')); ?></option>
                        <?php $__currentLoopData = $teacher; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teach): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($teach->id); ?>" <?php echo e($teach->id == $subject->teacher_id ? 'selected':''); ?>><?php echo e($teach->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
...
<?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/admin/subject/edit_subject.blade.php ENDPATH**/ ?>