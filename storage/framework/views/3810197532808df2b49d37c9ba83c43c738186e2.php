	...
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li class="nav-links-li <?php echo e(request()->is('teacher/marks') || request()->is('teacher/offline_exam') ? 'showMenu':''); ?>">
                ...
                <ul class="sub-menu">
                    <li>
                        <a class="<?php echo e((request()->is('teacher/marks')) ? 'active' : ''); ?>" href="<?php echo e(route('teacher.marks')); ?>"><span><?php echo e(get_phrase('Mark Grade')); ?></span></a>
                    </li>
	                ...
	                <a href="#">
	                    <div class="sidebar_icon">
                            ...
                            c0,0.477,0.384,0.859,0.859,0.859h17.613c0.474,0,0.859-0.382,0.859-0.859V1.195C19.665,0.721,19.281,0.337,18.807,0.337z
                             M17.948,17.946H2.052V4.528h15.896V17.946z"></path>  </div>
	                    <span class="link_name">
...
<?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/teacher/navigation.blade.php ENDPATH**/ ?>