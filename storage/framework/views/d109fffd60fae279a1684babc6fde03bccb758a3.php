        ...
        <div class="col-12">
            ...
            >
                <div class="d-flex flex-column">
                    <h4><?php echo e(get_phrase('Honor roll guide')); ?></h4>
                    <ul class="d-flex align-items-center eBreadcrumb-2">
                        <li><a href="#"><?php echo e(get_phrase('Home')); ?></a></li>
                        <li><a href="#"><?php echo e(get_phrase('Grading')); ?></a></li>
                        <li><a href="#"><?php echo e(get_phrase('Honor roll guide')); ?></a></li>
                    </ul>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('student.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/student/grade/grade_list.blade.php ENDPATH**/ ?>