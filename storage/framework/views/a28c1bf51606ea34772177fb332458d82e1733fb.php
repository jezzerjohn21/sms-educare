           ...
           <div class="row flex-wrap">
            <div class="col-lg-12">
                <div class="dashboard_ShortListItem">
                        ...
                        <p><?php echo e(get_phrase('Welcome, to')); ?> <?php echo e(DB::table('schools')->where('id', auth()->user()->school_id)->value('title')); ?><?php echo e(get_phrase(' Parent Dashboard')); ?></p>
                </div>
            </div>
...
<?php echo $__env->make('parent.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/parent/dashboard.blade.php ENDPATH**/ ?>