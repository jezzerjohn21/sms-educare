...
<br>
        <div class="row fmb-14 justify-content-between align-items-center">
            <label for="name"
                class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Display Name')); ?></label>
            <div class="col-sm-10 col-md-9 col-lg-10">
...
<br>
        <div class="row fmb-14 justify-content-between align-items-center">
            <label for="lrn" class="col-sm-2 col-eForm-label"><?php echo e(get_phrase('Learning referrence(LRN)')); ?></label>
            <div class="col-md-10">
...
<?php /**PATH C:\wamp64\www\fernandez\sms-educare\resources\views/admin/offline_admission/single_student_admission.blade.php ENDPATH**/ ?>