...
<div class="row" id="printableDiv">
  <div class="col-12">
    <div class="eSection-wrap-2">
        <img height="60px" class="" src="<?php echo e(asset('public/assets/uploads/logo/'.get_settings('light_logo'))); ?>" alt="" />
        <h4 class="invoice_title pb-21"><?php echo e(get_settings('system_title')); ?> </h4>
        <p class="sub-title"><?php echo e(get_settings('address')); ?><br>
...
<?php echo $__env->make('student.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/student/fee_manager/invoice.blade.php ENDPATH**/ ?>