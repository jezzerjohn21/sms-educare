...
<div class="eForm-layouts">
    <form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.teacher.create')); ?>">
        ...
        <div class="form-row">
            <div class="fpb-7">
                <label for="name" class="eForm-label"><?php echo e(get_phrase('Last Name')); ?></label>
                <input type="text" class="form-control eForm-control" id="lastName" required>
            </div>
            <div class="fpb-7">
                <label for="name" class="eForm-label"><?php echo e(get_phrase('First Name')); ?></label>
                <input type="text" class="form-control eForm-control" id="firstName"  required>
            </div>
            <div class="fpb-7">
                <label for="name" class="eForm-label"><?php echo e(get_phrase('MI *optional')); ?></label>
                <input type="text" class="form-control eForm-control" id="middleName">
            </div>
            <div class="fpb-7">
     
                <input type="text" class="form-control eForm-control hidden-input" id="fullName" readonly name = "name" required>
            </div>
            ...
            <div class="fpb-7">
                <label for="gender" class="eForm-label"><?php echo e(get_phrase('Sex')); ?></label>
...
</script><?php /**PATH /home/u523039989/domains/educareschoolhouse.online/public_html/sms-educare/resources/views/admin/teacher/add_teacher.blade.php ENDPATH**/ ?>